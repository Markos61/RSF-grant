...
for file in tqdm(files[:50], desc='Поиск наиболее похожих'):
...
for sim_column in sims:
    ...
    # Сохраняем результат
    filtered_df.to_excel(fr'E:\Грант\Формализация и схожесть\Результаты\схожесть1_{sim_column}.xlsx', index=False)
